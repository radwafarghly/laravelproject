...
Add Compound
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="{{ url('/adminpanel/buildings/edit') }}"> Edit Building </a></li>
        </ol>
        </div>
...
{!! Form::model($building, ['method' => 'PATCH','route' => ['building.update', $building->id],'enctype'=>'multipart/form-data']) !!}
<div class="row">
